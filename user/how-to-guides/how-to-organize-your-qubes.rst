...
- **One qube for all her credit card accounts.** Carol started to make
  ...
  credit card company websites being used to attach each other or her
...
- **But remember that compartmentalization — like everything else — can be taken to an extreme.** The appropriate amount depends on your
  ...
  constantly losing working (e.g., because you forget to transfer it
  out before the disposable self-destructs), then that’s a big problem!
