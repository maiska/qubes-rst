...
:doc:`minimal </user/templates/minimal-templates>` version of the template, if one
...
:ref:`here <introduction/faq:when i try to install a template, it says no match is found.>`.
